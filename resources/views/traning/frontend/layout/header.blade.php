        ...
        <div class="row">
            <div class="col-lg-5 col-xl-5">
                <ul class="home3_header_top_contact pull-left">
                    <li class="list-inline-item"><a href="tel:+08801894620088">01894620088</a></li>
                    <li class="list-inline-item"><a href="mailto:info@communicationit.com">info@communicationit.com</a></li>
                </ul>
            </div>
            <div class="col-lg-7 col-xl-7">
                <ul class="sign_up_btn pull-right dn-smd mt15 home3">
                    ...
                    <li class="list-inline-item">
                        <a href="{{route('login')}}" class="btn btn-md"><i class="flaticon-user"></i> <span class="dn-md">Login/Register</span></a>
                    </li>
                    <li class="list-inline-item">
                        <div class="cart_btn">
                            <ul class="cart">
    ...
    <div class="container-fluid">
        ...
        <nav>
            ...
            <div class="menu-toggle">
                <img class="nav_logo_img img-fluid" src="{{asset('traning/images/header-logo3.png')}}" alt="header-logo3.png">
            ...
            <a href="#" class="navbar_brand float-left dn-smd">
                <img class="logo1 img-fluid" src="{{asset('traning/images/header-logo.png')}}" alt="header-logo.png">
                <img class="logo2 img-fluid" src="{{asset('traning/images/header-logo2.png')}}" alt="header-logo2.png">
                <span>edumy</span>
            </a>
                                                                        ...
                                                                        <div class="col-lg-5 p0">
                                                                            <div class="element-img-widget-wrapper">
                                                                                <div class="element-widget-thumb">
                                                                                    <a href="#"><img class="img-fluid" src="{{asset('traning/images/resource/1.png')}}" alt="1.png"></a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
    ...
    <div class="mobile-menu">
        <div class="header stylehome1">
            <div class="main_logo_home2">
                <img class="nav_logo_img img-fluid float-left mt20" src="{{asset('traning/images/header-logo.png')}}" alt="header-logo.png">
                <span>edumy</span>
            </div>
