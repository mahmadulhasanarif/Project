		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-xl-6">					
					<div class="breadcrumb_content mt0">
						<div class="cs_row_one csv2">
							<div class="cs_ins_container mb30-smd">
								<div class="cs_instructor">
									<ul class="cs_instrct_list mb0">
								...
								<div class="sidebar_course_widget style3">
									<div class="course_list_details">
										<ul class="icon-box-list style2 mb40">
								...
								<ul class="cs_watch_list mb0">
									...
									<li class="list-inline-item ml20"><a class="color-white share_btn" href="#"><span class="flaticon-share"> Share</span></a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-6 col-xl-6">
					<div class="video_content_wrapper">
						<div class="blog_post_home6 style3 video mb30">
						...
						<div class="price_title df float-left mt10 text-white">Price <span class="custome_price pr10 pl10 vas text-white">$49.00</span> $69.00</div>
						<a class="btn buy_now_btn dbxshad btn-lg btn-thm3 mt0 float-right" href="#">Buy & Enrol Now</a>						
					</div>
				</div>
			</div>
		</div>
