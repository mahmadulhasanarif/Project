  ...
  <body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card mt-3">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-7">
                                <marquee class="text-danger"><h4><b>Contact Massage table</b></h4></marquee>
                            </div>
                            <div class="col-md-5">
                                <div class="row">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                    ...
                                    data-id={{ $contact->id }} ><i class="fa-solid fa-xmark"></i></button>
                                </td>
                              </tr>
                              @endforeach
                            </tbody>
            ...
            <div class="col-md-2 mt-3"><button type="submit" class="btn btn-success addModalButton" data-bs-toggle="modal" data-bs-target="#addContactModal">Add Contact</button></div>
        </div>
    </div>
