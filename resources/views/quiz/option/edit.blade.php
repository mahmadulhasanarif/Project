                ...
                <div class="card"><br><br>
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <h4><b>Option Edit table</b></h4>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{route('quiz_option.update', $option->id)}}" method="POST">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                <input type="text" value="{{old('option_text', $option->option_text)}}" name="option_text" placeholder="Enter Option Text" class="form-control">
                            </div>
                            <div class="form-group mb-3">
                                <input type="text" name="points" value="{{old('points', $option->points)}}" placeholder="Enter Points" class="form-control">
                            </div>
                            <div class="row">
